...
export const addProduct = async (req, res) => {
    try {
        ...
        const { name, description, price, stock, mrp, category, imageUrl } = req.body; // ✅ category added
        const imageFile = req.file;
        const productImage = imageFile?.path || imageUrl;
        ...
        const product = await Product.create({
            name, description, price, stock, mrp, category, // ✅ category included
            image: productImage,
        });
